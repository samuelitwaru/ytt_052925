...
namespace GeneXus.Programs {
   public class gamactivateuseraccount : GXDataArea
   {
      ...
      protected void E110E2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV8isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).activateuser(AV5ActivationKey, true, out  AV31Errors);
         if ( AV8isOK )
         {
         ...
         {
            AV42GXV1 = 1;
            while ( AV42GXV1 <= AV31Errors.Count )
            {
               AV30Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV31Errors.Item(AV42GXV1));
               lblTbmsg_Caption = StringUtil.Trim( AV30Error.gxTpr_Message);
               AssignProp("", false, lblTbmsg_Internalname, "Caption", lblTbmsg_Caption, true);
               if (true) break;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025523892031", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamactivateuseraccount.js", "?2025523892034", false, true);
