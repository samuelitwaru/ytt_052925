      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            while ( (pr_default.getStatus(1) != 101) )
            {
               ...
               AV22Expected = (long)((A188EmployeeFTEHours*60)-AV34Leave);
               ...
               AV23SDTEmployeeWeekReport.gxTpr_Leave = AV34Leave;
               ...
               GXt_char9 = "";
               new formattime(context ).execute(  AV34Leave, out  GXt_char9) ;
