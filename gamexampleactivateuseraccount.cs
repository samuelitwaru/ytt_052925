...
namespace GeneXus.Programs {
   public class gamexampleactivateuseraccount : GXHttpHandler
   {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV28GXV1 = 1;
         while ( AV28GXV1 <= AV26GAMErrorCollection.Count )
         {
            AV25GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV26GAMErrorCollection.Item(AV28GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025523652161", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleactivateuseraccount.js", "?2025523652165", false, true);
