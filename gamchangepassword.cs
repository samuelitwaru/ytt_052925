...
namespace GeneXus.Programs {
   public class gamchangepassword : GXHttpHandler
   {
      ...
      protected void E11062( )
      {
         ...
         AV32User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getusertochangepassword();
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV32User.gxTpr_Name)) )
         {
            AV10UserName = AV32User.gxTpr_Name;
            AssignAttri("", false, "AV10UserName", AV10UserName);
         }
         else
         {
      ...
      protected void E12062( )
      {
         ...
         {
            AV7isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).updateusertochangepassword(AV11UserPassword, AV12UserPasswordNew, out  AV31Errors);
            if ( AV7isOK )
            {
      ...
      protected void E13062( )
      {
         ...
         returnInSub = false;
         AV7isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).logout(out  AV31Errors);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV37GXV1 = 1;
         while ( AV37GXV1 <= AV31Errors.Count )
         {
            AV30Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV31Errors.Item(AV37GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025523892849", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamchangepassword.js", "?2025523892852", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV32User = new GeneXus.Programs.genexussecurity.SdtGAMUser(context);
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMUser AV32User ;
