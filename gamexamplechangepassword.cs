...
namespace GeneXus.Programs {
   public class gamexamplechangepassword : GXHttpHandler
   {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV29GXV1 = 1;
         while ( AV29GXV1 <= AV25GAMErrorCollection.Count )
         {
            AV27GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV25GAMErrorCollection.Item(AV29GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255236344276", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplechangepassword.js", "?20255236344280", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
