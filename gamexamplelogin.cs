...
namespace GeneXus.Programs {
   public class gamexamplelogin : GXDataArea
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "GRIDAUTHTYPES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavImageauthtype_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV60ImageAuthType)) ? AV72Imageauthtype_GXI : context.convertURL( context.PathToRelativeUrl( AV60ImageAuthType))), !bGXsfl_60_Refreshing);
      ...
      protected void E14032( )
      {
         ...
         else
         {
            if ( ! AV18isConnectionOK )
            {
               ...
               {
                  AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryguid(AV28RepositoryGUID, out  AV58Errors);
                  AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
               }
               else
               {
                  ...
                  {
                     AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnection(((GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo)AV9ConnectionInfoCollection.Item(1)).gxTpr_Name, out  AV58Errors);
                     AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
                  }
               }
            }
      ...
      protected void E12032( )
      {
         ...
         AV24LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV31UserName, AV32UserPassword, AV5AdditionalParameter, out  AV58Errors);
         if ( AV24LoginOK )
         {
      ...
      protected void E16032( )
      {
         ...
         if ( ! AV61isRedirect )
         {
            ...
            if ( AV65SessionValid && ! AV64Session.gxTpr_Isanonymous )
            {
               ...
               if ( String.IsNullOrEmpty(StringUtil.RTrim( AV30URL)) )
               {
                  AV68GAMApplicationCollection = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getapplications(AV69GAMApplicationFilter, out  AV58Errors);
                  AV73GXV2 = 1;
            ...
            else
            {
               ...
               AV7AuthenticationTypes = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getenabledauthenticationtypes(AV23Language, out  AV58Errors);
               AV74GXV3 = 1;
               ...
               AV20isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getrememberlogin(out  AV25LogOnTo, out  AV8AuxUserName, out  AV33UserRememberMe, out  AV58Errors);
               ...
               if ( cmbavLogonto.ItemCount > 1 )
               {
                  AV25LogOnTo = AV63Repository.gxTpr_Defaultauthenticationtypename;
                  AssignAttri("", false, "AV25LogOnTo", AV25LogOnTo);
               }
      ...
      protected void S112( )
      {
         ...
         {
            AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryid(AV13GAMRepository.gxTpr_Authenticationmasterrepositoryid, out  AV58Errors);
            AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
         }
         if ( ! AV18isConnectionOK )
         {
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         AV77GXV6 = 1;
         while ( AV77GXV6 <= AV58Errors.Count )
         {
      ...
      protected void sendrow_602( )
      {
         ...
         StyleString = "";
         AV60ImageAuthType_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV60ImageAuthType))&&String.IsNullOrEmpty(StringUtil.RTrim( AV72Imageauthtype_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV60ImageAuthType)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV60ImageAuthType)) ? AV72Imageauthtype_GXI : context.PathToRelativeUrl( AV60ImageAuthType));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDAUTHTYPES.LOAD",""","oparms":[{"av":"AV60ImageAuthType","fld":"vIMAGEAUTHTYPE"},{"av":"cmbavTypeauthtype"},{"av":"AV66TypeAuthType","fld":"vTYPEAUTHTYPE"},{"av":"AV26NameAuthType","fld":"vNAMEAUTHTYPE"},{"av":"edtavImageauthtype_Tooltiptext","ctrl":"vIMAGEAUTHTYPE","prop":"Tooltiptext"},{"av":"divTablebuttons_Visible","ctrl":"TABLEBUTTONS","prop":"Visible"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV26NameAuthType = "";
         AV28RepositoryGUID = "";
         AV58Errors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         ...
         AV59ErrorsLogin = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
