...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep2 : GXDataArea
   {
      ...
      protected void E120B2( )
      {
         ...
         {
            AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbylogin(AV14UserAuthTypeName, AV15UserName, out  AV28Errors);
            if ( AV28Errors.Count == 0 )
            {
               AV6ChangePwdOK = AV13User.changepasswordbykey(AV10KeyToChangePassword, AV16UserPasswordNew, out  AV28Errors);
               if ( AV6ChangePwdOK )
               {
                  ...
                  AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV15UserName, AV16UserPasswordNew, AV5AdditionalParameter, out  AV28Errors);
                  if ( AV11LoginOK )
                  {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV30GXV1 = 1;
         while ( AV30GXV1 <= AV28Errors.Count )
         {
            AV27Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV28Errors.Item(AV30GXV1));
            GX_msglist.addItem(StringUtil.Format( "%1", AV27Error.gxTpr_Message, "", "", "", "", "", "", "", ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202552320143355", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep2.js", "?202552320143356", false, true);
