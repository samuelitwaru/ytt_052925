   ...
   public class gamotpauthentication : GXHttpHandler
   {
      ...
      protected void E11082( )
      {
         ...
         else
         {
            ...
            AV33GXV1 = 1;
            while ( AV33GXV1 <= AV29Errors.Count )
            {
               AV28Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV29Errors.Item(AV33GXV1));
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV34GXV2 = 1;
         while ( AV34GXV2 <= AV29Errors.Count )
         {
            AV28Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV29Errors.Item(AV34GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025523892812", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamotpauthentication.js", "?2025523892814", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
