...
namespace GeneXus.Programs {
   public class gamssologin : GXHttpHandler
   {
      ...
      protected void E110D2( )
      {
         ...
         {
            AV8isOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnection(((GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo)AV5ConnectionInfoCollection.Item(1)).gxTpr_Name, out  AV21Errors);
         }
         AV9isRedirect = false;
         AV21Errors = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
         if ( ( AV21Errors.Count > 0 ) && ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV21Errors.Item(1)).gxTpr_Code != 104 ) )
         {
         ...
         {
            AV11SessionValid = new GeneXus.Programs.genexussecurity.SdtGAMSession(context).isvalid(out  AV10Session, out  AV21Errors);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV22GXV1 = 1;
         while ( AV22GXV1 <= AV21Errors.Count )
         {
            AV20Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV21Errors.Item(AV22GXV1));
            if ( AV20Error.gxTpr_Code != 13 )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255241639316", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("gamssologin.js", "?20255241639319", false, true);
         }
