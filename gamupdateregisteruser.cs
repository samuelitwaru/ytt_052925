...
namespace GeneXus.Programs {
   public class gamupdateregisteruser : GXDataArea
   {
      ...
      protected void E11072( )
      {
         ...
         AV51User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbykeytocompleteuserdata(out  AV46Errors);
         ...
         else
         {
            ...
            S112 ();
            if (returnInSub) return;
            AV16Name = AV51User.gxTpr_Name;
            AssignAttri("", false, "AV16Name", AV16Name);
            AV6EMail = AV51User.gxTpr_Email;
            AssignAttri("", false, "AV6EMail", AV6EMail);
            AV7FirstName = AV51User.gxTpr_Firstname;
            AssignAttri("", false, "AV7FirstName", AV7FirstName);
            AV15LastName = AV51User.gxTpr_Lastname;
            AssignAttri("", false, "AV15LastName", AV15LastName);
            AV5Birthday = AV51User.gxTpr_Birthday;
            AssignAttri("", false, "AV5Birthday", context.localUtil.Format(AV5Birthday, "99/99/9999"));
            AV12Gender = AV51User.gxTpr_Gender;
            AssignAttri("", false, "AV12Gender", AV12Gender);
         }
      ...
      protected void E12072( )
      {
         ...
         {
            AV51User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbykeytocompleteuserdata(out  AV46Errors);
            AV51User.load( AV51User.gxTpr_Guid);
            AV51User.gxTpr_Name = AV16Name;
            AV51User.gxTpr_Email = AV6EMail;
            AV51User.gxTpr_Firstname = AV7FirstName;
            AV51User.gxTpr_Lastname = AV15LastName;
            AV51User.gxTpr_Birthday = AV5Birthday;
            AV51User.gxTpr_Gender = AV12Gender;
            AV14isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).updateuserbykeytocompleteuserdata(AV51User, out  AV46Errors);
            if ( AV14isOK )
            {
               if ( AV46Errors.Count > 0 )
               {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV52GXV1 = 1;
         while ( AV52GXV1 <= AV46Errors.Count )
         {
            AV45Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV46Errors.Item(AV52GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202552320575360", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamupdateregisteruser.js", "?202552320575365", false, true);
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV51User = new GeneXus.Programs.genexussecurity.SdtGAMUser(context);
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMUser AV51User ;
