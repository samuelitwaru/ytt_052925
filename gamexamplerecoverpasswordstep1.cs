...
namespace GeneXus.Programs {
   public class gamexamplerecoverpasswordstep1 : GXHttpHandler
   {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV23GXV1 = 1;
         while ( AV23GXV1 <= AV21GAMErrorCollection.Count )
         {
            AV20GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV21GAMErrorCollection.Item(AV23GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255236342651", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplerecoverpasswordstep1.js", "?20255236342655", false, true);
