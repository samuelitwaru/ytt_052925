...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep1 : GXDataArea
   {
      ...
      protected void S112( )
      {
         ...
         {
            AV23Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV6Errors.Item(AV25GXV1));
            GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV23Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV23Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255232012422", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep1.js", "?20255232012424", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV8LinkURL = "";
         AV23Error = new GeneXus.Programs.genexussecurity.SdtGAMError(context);
         sStyleString = "";
         TempTags = "";
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMError AV23Error ;
